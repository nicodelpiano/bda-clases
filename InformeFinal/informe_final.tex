...
El objetivo de las \textit{BDET} es extender los modelos de informaci\'on espacial para inclu\'ir tiempo y describir de forma m\'as din\'amica la realidad que se quiere representar. Se requiere que una \textit{BDET} sea capaz de representar modelos muy cercanos al mundo real y administrar objetos que cambian su ubicaci\'on y/o forma a trav\'es del tiempo.
Se han convertido en un t\'opico muy imporante en estos \'ultimos a\~nos, ya que muchas de las aplicaciones como los \textit{Sistemas de Informaci\'on Geogr\'afica} y los sistemas de localizaci\'on necesitan almacenar datos espaciales con caracter\'isticas temporales.
...
\end{figure}
\ \\
Soporta diferentes DBMS, incluyendo Oracle, PostgreSQL y MySQL. Se programa en C++. Tiene su centro de desarrollo en Brasil y se distribuye bajo la licencia LGPL. Existen varias aplicaciones asociadas para facilitar la visualizaci\'on de consultas y el manejo del usuario.\\
\ \\
\begin{figure}
\centering
